# Generated by Powerlevel10k configuration wizard on 2026-04-14 at 11:49 CEST.
...
() {
  ...
  ################################[ prompt_char: prompt symbol ]################################
  # Bold red prompt symbol always (matching old theme).
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=red
  # Bold red on error too, with † indicator.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=red
  # OK prompt symbol.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIINS_CONTENT_EXPANSION='%B➜%b'
  # Error prompt symbol with † indicator.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIINS_CONTENT_EXPANSION='%B† ➜%b'
  ...
  ##################################[ dir: current directory ]##################################
  # Current directory color (cyan, matching old theme).
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      # Styling for up-to-date Git status (old theme colors).
      local       meta='%f'     # default foreground
      local      clean='%B%1F'   # bold red (same ANSI red as the arrow)
      local   modified='%178F'  # yellow foreground
      local  untracked='%178F'  # yellow foreground (matching old theme ✗)
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      res+="${clean}${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}${branch//\%/%%}%b"
    fi
    ...
    # Lean dirty indicator: yellow ✗ when repo has any changes (matching old theme).
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=red
  typeset -g POWERLEVEL9K_VCS_LOADING_VISUAL_IDENTIFIER_COLOR=244
  # No icon, just text (lean style).
  ...
  # Python version color (yellow, matching old theme).
  typeset -g POWERLEVEL9K_PYTHON_VERSION_FOREGROUND=yellow
  # Always show python version, even outside Python projects.
  ...
  ####################[ go_version: go version (https://golang.org) ]#####################
  # Go version color (cyan, matching the dir color).
  typeset -g POWERLEVEL9K_GO_VERSION_FOREGROUND=cyan
  # Always show go version, even outside Go projects.
